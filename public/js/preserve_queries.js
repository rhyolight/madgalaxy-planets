...
$('#pageForward').click(function(event) {
  window.location.href = preserveTags('pageNum=' + $('#pageForward').attr('data-pageNum'));
});
$('#pageBackward').click(function(event) {
  window.location.href = preserveTags('pageNum=' + $('#pageBackward').attr('data-pageNum'));
});